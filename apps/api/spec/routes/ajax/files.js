...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, mimetype, originalname, uploadUrl, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, mimetype = _a.mimetype, originalname = _a.originalname;
                if (!mimetype || !originalname)
                    return [2 /*return*/, res.sendStatus(http_status_1["default"].BAD_REQUEST)];
                return [4 /*yield*/, storage_1["default"]
                        .file("public/".concat(originalname))
                        .getSignedUrl({
                        version: 'v4',
                        action: 'write',
