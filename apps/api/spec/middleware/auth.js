...
function auth() {
    var _this = this;
    var authHandler = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!req.cookies.authorization) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    next();
                    _a.label = 2;
                case 2: return [2 /*return*/, res.status(http_status_1["default"].UNAUTHORIZED).send({
                        error: {
