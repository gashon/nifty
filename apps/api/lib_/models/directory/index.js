...
directorySchema.plugin((0, mongoose_object_id_1["default"])('dir', 'directory'));
directorySchema.index({ created_by: 1, name: 1 }, { unique: true });
__exportStar(require("./types"), exports);
exports["default"] = mongoose_1["default"].models.Directory ||
    mongoose_1["default"].model('Directory', directorySchema);
