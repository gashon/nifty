...
export class QuizService implements IQuizService {
  ...
  private submissionModel: Model<ISubmission>;
  ...
  async findQuizzesByIds(
    ids: string[]
  ): Promise<
    Query<
      (QuizDocument & Required<{ _id: string }>)[],
      QuizDocument & Required<{ _id: string }>,
      {},
      QuizDocument
    >
  ...
  async createQuiz(
    createdBy: string,
    data: Omit<IQuiz, 'created_by' | keyof Resource>
  ...
  async deleteQuizById(
    ...
    Query<any, QuizDocument & Required<{ _id: string }>, {}, QuizDocument>
  > {
  ...
  async submitQuiz(
    createdBy: string,
    submissionAttributes: Omit<ISubmission, keyof Resource | 'created_by'>
