...
describe('Module Card Molecule', () => {
  ...
  it('should render tasks remaining', () => {
    ...
    expect(screen.getByText(`${args.tasks as number} tasks remaining`)).toBeInTheDocument();
  });
  ...
  it('should render credits', () => {
    ...
    expect(screen.getByText(`${args.credits as number} Credits`)).toBeInTheDocument();
  });
});
