...
describe('UserCard molecule', () => {
  ...
  it('should trigger the sign out on click', async () => {
    ...
    (nextAuthReact.signOut as jest.Mock).mockImplementation(() => Promise.resolve(mockedSignOut()));
  ...
  it('should render the image placeholder if no avatar is found', () => {
    ...
    expect(screen.getByRole('img')).toHaveAttribute('src', '/user-placeholder.svg');
  });
});
